...
// AGREGARLO AL FINAL
procedure agregarFinal(var l, ultimo: lista; min: string);
...
begin
    ...
    while (min <> 999) do begin
        ...
        agregarFinal(newL, ultimo, actual, montoTotal);
    end;
end;
...
// AGREGARLO AL FINAL
procedure agregarFinal(var l, ultimo: lista; actual: integer; montoTotal: real);
var
    nuevo: lista;
begin
    new(nuevo);
